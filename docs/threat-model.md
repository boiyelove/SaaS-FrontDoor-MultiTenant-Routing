...
Project-specific acceptance focus: Test domain takeover defenses, ownership challenge, duplicate domains, certificate delay/renewal, WAF isolation, host-header routing, origin failure, purge, rate limits, tenant deletion, and audit logs.
